...
namespace WebAPI.Core.Models.NorthwindDB
{
    public partial class NorthwindDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //    optionsBuilder.UseSqlServer("Data Source=DIIN-MAHERNANDE\\SQLDEV2016;Initial Catalog=Northwind;Integrated Security=True;");
            //}
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categories>(entity =>
            {
                ...
                entity.Property(e => e.ActualizadoPor).HasMaxLength(128);
                ...
                entity.Property(e => e.CreadoPor).HasMaxLength(128);

                entity.Property(e => e.Description).HasColumnType("ntext");

                entity.Property(e => e.EliminadoFecha).HasColumnType("datetime");

                entity.Property(e => e.EliminadoPor).HasMaxLength(128);
